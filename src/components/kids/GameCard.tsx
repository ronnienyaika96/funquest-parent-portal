...
const GameCard = ({ title, emoji, color, progress, isNew, onClick }: GameCardProps) => {
  return (
    ...
    >
      <div 
        className={`w-[calc(50vw-2rem)] h-[calc(50vw-1rem)] sm:w-[calc(50%-2rem)] sm:h-80 max-w-none sm:max-w-[480px] max-h-[320px] sm:max-h-[380px] rounded-3xl shadow-xl flex flex-col items-center justify-center relative overflow-hidden ${color}`}
      >
        {/* Decorative circles */}
